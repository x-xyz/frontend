...
export default function ReactWindowScroller({ children, throttleTime = 10, isGrid = false }: ReactWindowScrollerProps) {
  ...
  useEffect(() => {
    const handleWindowScroll = throttle(() => {
      ...
      if (isGrid) ref.current && ref.current.scrollTo({ scrollTop, scrollLeft })
