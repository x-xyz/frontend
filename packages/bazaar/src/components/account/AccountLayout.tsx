...
import { ThreeDEffect } from '@x/components/effects'
...
export default function AccountLayout({ children, address, ...props }: AccountLayoutProps) {
  ...
  function renderAvatar() {
    return (
      <SkeletonCircle width={24} height={24} isLoaded={!isLoadingAccountDetail} overflow="hidden">
        <Image src={accountDetail?.data?.imageHash} />
      </SkeletonCircle>
    )
  }
    ...
    <>
      <Stack alignItems="center" px={0} {...props}>
        ...
        >
          ...
          <ThreeDEffect maxW="600px" w="100%" h="400px">
            <AccountBanner
              p={8}
