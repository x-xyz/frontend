...
import { callOnChain, getFirst } from '@x/utils'
...
import { compareBigNumberish } from '@x/utils'
...
function createDefaultValue(auction?: Auction, chainId = defaultNetwork): Partial<FormData> {
  if (!auction)
    return {
      reservePrice: '0',
