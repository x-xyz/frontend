...
export default function Navbar() {
  ...
  return (
    <Center w="full" borderBottom="1px solid" borderColor="divider" fontWeight="extrabold">
      <NavLink href="/wagmi-3/nfts">NFTs</NavLink>
      <NavLink href="/wagmi-3/collections">Collections</NavLink>
      {account && (
        <NavLink href={`/wagmi-3/${account}/nfts`} matchRoute="/wagmi-3/[account]/nfts">
          My Eligible NFTs
        </NavLink>
      )}
    </Center>
