      ...
      <Stack px={5} py={4} spacing={5}>
        ...
        <Stack direction="row" align="center" spacing={5}>
          ...
          <Price
            ...
            price={collection && collection.openseaFloorPriceInNative * count}
            // priceInUsd={collection && collection.usdFloorPrice * collection.holdingCount}
            unit="ETH"
            isLoading={!collection}
          />
          <Spacer />
