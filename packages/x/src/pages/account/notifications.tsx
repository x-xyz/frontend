...
import { useLazyNotificationSettingsQuery, useUpdateNotificationSettingsMutation } from '@x/apis'
...
export default function Notifications() {
  ...
  const isLoading = isLoadingAuthToken || nonceMutation.isLoading || isLoadingData || isSubmitting
