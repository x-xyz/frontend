...
const CopyIcon = forwardRef<SVGSVGElement, ChakraProps>((props, ref) => (
  <chakra.svg ref={ref} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 60 60" {...props}>
