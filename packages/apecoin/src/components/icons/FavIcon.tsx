...
const FavIcon = forwardRef<SVGSVGElement, ChakraProps>((props, ref) => (
  <chakra.svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 32 32" ref={ref} {...props}>
