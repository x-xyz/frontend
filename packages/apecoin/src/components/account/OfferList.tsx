...
import { ChainId, NftItem, PriceSource, TokenType } from '@x/models'
...
> = {
  ...
  [PriceSource.AuctionReserve]: () => null,
  [PriceSource.AuctionBid]: () => null,
}
  ...
  function renderListings() {
    return (
      <Accordion allowToggle m="-1px">
        <AccordionItem>
          <AccordionButton>
            <Text flex={1} textAlign="right" fontSize="sm" mr={8} color="placeholder">
  ...
  return (
    <Box border="1px solid" borderColor="divider">
      <Stack h="100px" direction="row" divider={<Divider orientation="vertical" />} bg="#272b2c" p={2.5}>
        ...
        <Grid w="full" templateColumns="repeat(6, 1fr)" templateRows="repeat(3, 1fr)" columnGap={1} rowGap={1}>
          ...
          <GridItem fontSize="xs" color="tableHeader" colSpan={2}>
            Expiration
          </GridItem>
          <GridItem fontSize="xs" color="tableHeader">
            Listed Date
