...
export default function ProfitEstimation({
  ...
  const earning = useMemo(() => sellPrice * (1 - marketplaceFee - royalty), [sellPrice, marketplaceFee, royalty])
  ...
  return (
    <Stack>
      ...
      <Grid templateColumns="1fr auto" lineHeight={1.2} py={3}>
        ...
        <GridItem color="note">Marketplace Fees</GridItem>
        <GridItem fontWeight="bold" textAlign="right">
          {(marketplaceFee * 100).toFixed(3)}%
        </GridItem>
