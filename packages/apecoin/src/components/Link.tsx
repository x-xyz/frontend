...
function Link(
  { children, href: inputHref, locale, disabled, forceInternal, showExternalIcon, isActive, ...rest }: LinkProps,
  ...
  function renderChakraLink(href?: string, isExternal?: boolean) {
    return (
      ...
      >
        {children}
        {isExternal && showExternalIcon && <ExternalIcon w="7px" h="7px" ml="6px" />}
      </ChakraLink>
    )
  }
